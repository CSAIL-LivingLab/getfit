...
//        [sensingIncludesTextView setFont:[UIFont systemFontOfSize:12]];
        ...
        // livinglab
        livingLabTitle = [[UILabel alloc] initWithFrame:CGRectMake(8, sensingIncludesTextView.frame.origin.y + sensingIncludesTextView.frame.size.height + 8, bounds.width-16, 18)];
        ...
        // faq
        faqTitle = [[UILabel alloc] initWithFrame:CGRectMake(8, livingLabTextView.frame.origin.y + livingLabTextView.frame.size.height + 5, bounds.width-16, 15)];
